...
DB_HOME=/home/swgemu/workspace/Core3/MMOCoreORB/bin/databases
export DB_HOME
 
# backup dir (should be on another filesystem)
DB_BACKUP=/home/swgemu/Dropbox/backup/ondemand/
export DB_BACKUP
