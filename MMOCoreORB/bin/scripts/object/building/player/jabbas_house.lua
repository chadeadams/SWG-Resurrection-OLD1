...
object_building_player_jabbas_house = object_building_player_shared_jabbas_house:new {
	...
	childObjects = {
                {templateFile = "object/tangible/sign/player/shop_sign_s01.iff", x = 1.5, z = 0.20, y = -5, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "crafting_merchant_management_01", suiItem = "@player_structure:shop_sign1"},
		--{templateFile = "object/tangible/sign/player/shop_sign_s03.iff", x = 1.5, z = 0.20, y = -5, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "crafting_merchant_management_03", suiItem = "@player_structure:shop_sign3"},
