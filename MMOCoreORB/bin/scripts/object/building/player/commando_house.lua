...
object_building_player_commando_house = object_building_player_shared_commando_house:new {
	...
	childObjects = {
{templateFile = "object/tangible/sign/player/shop_sign_s01.iff", x = 5, z = 0.35, y = 8.50, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "crafting_merchant_management_01", suiItem = "@player_structure:shop_sign1"},
--{templateFile = "object/tangible/sign/player/house_address.iff", x = -8.85, z = 3.4, y = 0.95, ox = 0, oy = 0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1},
