...
object_building_player_tree_house = object_building_player_shared_tree_house:new {
	...
	childObjects = {
                {templateFile = "object/tangible/sign/player/shop_sign_s01.iff", x = 12.5, z = 0.15, y = 26.75, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "crafting_merchant_management_01", suiItem = "@player_structure:shop_sign1"},
