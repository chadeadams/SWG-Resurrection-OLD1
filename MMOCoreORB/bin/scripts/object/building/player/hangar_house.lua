...
object_building_player_hangar_house = object_building_player_shared_hangar_house:new {
	...
	childObjects = {
        {templateFile = "object/tangible/sign/player/shop_sign_s01.iff", x = -7.5, z = -0.60, y = 10, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "crafting_merchant_management_01", suiItem = "@player_structure:shop_sign1"},
	--{templateFile = "object/tangible/sign/player/house_address.iff", x = 15.20, z = 3.4, y = 15.60, ox = 0, oy = 0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1},
