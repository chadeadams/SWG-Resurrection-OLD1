...
object_building_player_naboo_small_window_s01 = object_building_player_shared_naboo_small_window_s01:new {
	...
	childObjects = {
{templateFile = "object/tangible/sign/player/shop_sign_s01.iff", x =3.75, z = 0.50, y = -9, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "crafting_merchant_management_01", suiItem = "@player_structure:shop_sign1"},
