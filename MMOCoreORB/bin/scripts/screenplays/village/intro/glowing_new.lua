...
TOTALNUMBEROFBADGESREQUIRED = 55

NUMBEROFBASICBADGESREQUIRED = 3
NUMBEROFRESURRECTIONBADGESREQUIRED = 4
NUMBEROFPOIBADGESREQUIRED = 35
NUMBEROFPROFESSIONBADGESREQUIRED = 10
...
function Glowing:countBadges(pPlayer)
	...
	local basicBadges = self:countBadgesInListToUpperLimit(pPlayer, BASICBADGES, NUMBEROFBASICBADGESREQUIRED)
	local contentBadges = self:countBadgesInListToUpperLimit(pPlayer, CONTENTBADGES, NUMBEROFCONTENTBADGESREQUIRED)
	local resurrectionBadges = self:countBadgesInListToUpperLimit(pPlayer, RESURRECTIONBADGES, NUMBEROFRESURRECTIONBADGESREQUIRED)
	local poiBadges = self:countBadgesInListToUpperLimit(pPlayer, POIBADGES, NUMBEROFPOIBADGESREQUIRED)
	return professionBadges + basicBadges + contentBadges + resurrectionBadges + poiBadges
end
